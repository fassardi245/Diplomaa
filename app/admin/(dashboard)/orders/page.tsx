  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto">
      ...
      <div className="mb-8 flex flex-col gap-2">
        ...
        <p className="text-gray-500">Historial de transacciones y envíos. Total: {orders.length} órdenes.</p>
      </div>
                ...
                <TableRow key={order._id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <TableCell>
                    <Badge variant="secondary" className={`
                        ...
                        ${order.status === 'cancelado' ? 'bg-red-50 text-red-600 hover:bg-red-100 border border-red-100' : ''}
                    `}>
